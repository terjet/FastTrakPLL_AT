CREATE TABLE [dbo].[Person] (
  ...
  [ExistsInProfil] [bit] NOT NULL DEFAULT (0),
  [TestAbel] [bit] NOT NULL DEFAULT (0),
  [ExistsInFm] [bit] NULL DEFAULT (0),
  [Profil] [bit] NOT NULL DEFAULT (0),
  [FromKith] [bit] NOT NULL DEFAULT (0),
  [FromTestAbel] [bit] NOT NULL DEFAULT (0),
