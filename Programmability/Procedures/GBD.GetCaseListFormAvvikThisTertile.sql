...
GO
CREATE PROCEDURE [GBD].[GetCaseListFormAvvikThisTertile] (@StudyId INT) AS
BEGIN
...
GRANT EXECUTE ON [GBD].[GetCaseListFormAvvikThisTertile] TO [Gruppeleder]
GO

GRANT EXECUTE ON [GBD].[GetCaseListFormAvvikThisTertile] TO [Lege]
GO