...
GO
CREATE PROCEDURE [NDV].[GetPumpWithHighHbA1c]( @StudyId INT, @AgeMin FLOAT, @AgeMax FLOAT, @HbA1cCutoff FLOAT ) AS
BEGIN
...
GRANT EXECUTE ON [NDV].[GetPumpWithHighHbA1c] TO [FastTrak]
GO