...
GO
CREATE PROCEDURE [Dash].[BdrHbA1cBelowInPeriod]( @Hba1cCutoff NUMERIC(5,2), @ConsultationLookback INT, @DiagnosisPeriodLookback INT, @MinPatientCount INT ) AS
BEGIN
...
GRANT EXECUTE ON [Dash].[BdrHbA1cBelowInPeriod] TO [FastTrak]
GO