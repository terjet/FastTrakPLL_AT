...
GO
CREATE FUNCTION [CRF].[GetGroupOnDate](@PersonId INT, @StudyName VARCHAR(24), @Cutoff DATETIME, @NewerIfNull INT =  0)
RETURNS INT AS
BEGIN
	...
	SELECT TOP 1 @RetVal = NewGroupId
	FROM StudCaseLog
...
GRANT EXECUTE ON [CRF].[GetGroupOnDate] TO [Administrator]
GO